...
contextBridge.exposeInMainWorld('worshipsync', {
  ...
  sync: {
    ...
    chooseWorkspaceFolder:  ()                     => ipcRenderer.invoke('sync:chooseWorkspaceFolder'),
    openWorkspaceFolder:    ()                     => ipcRenderer.invoke('sync:openWorkspaceFolder'),
    listPublishableServices: ()                    => ipcRenderer.invoke('sync:listPublishableServices'),
    previewPublish:         (serviceDateId: number) => ipcRenderer.invoke('sync:previewPublish', serviceDateId),
    publishService:         (serviceDateId: number) => ipcRenderer.invoke('sync:publishService', serviceDateId),
    checkWorkspace:         ()                     => ipcRenderer.invoke('sync:checkWorkspace'),
    verifyPackage:          (filename: string)      => ipcRenderer.invoke('sync:verifyPackage', filename),
    importPackage:          (filename: string)      => ipcRenderer.invoke('sync:importPackage', filename),
